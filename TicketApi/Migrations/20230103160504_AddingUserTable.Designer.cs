...
namespace TicketApi.Migrations
{
    ...
    [Migration("20230103160504_AddingUserTable")]
            ...
            modelBuilder.Entity("TicketApi.Models.Passenger", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreditCardId = 1,
                            DateOfBirth = new DateTime(1983, 1, 3, 17, 5, 4, 511, DateTimeKind.Local).AddTicks(419),
                            LoyaltyProgramId = 1,
                            ReportId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreditCardId = 2,
                            DateOfBirth = new DateTime(1967, 1, 3, 17, 5, 4, 511, DateTimeKind.Local).AddTicks(425),
                            LoyaltyProgramId = 2,
                            ReportId = 2
                        });
                });
            ...
            modelBuilder.Entity("TicketApi.Models.Schedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Arrival = new DateTime(2023, 1, 3, 20, 5, 4, 511, DateTimeKind.Local).AddTicks(166),
                            Departure = new DateTime(2023, 1, 3, 17, 5, 4, 511, DateTimeKind.Local).AddTicks(129)
                        },
                        new
                        {
                            Id = 2,
                            Arrival = new DateTime(2023, 1, 3, 17, 5, 4, 511, DateTimeKind.Local).AddTicks(172),
                            Departure = new DateTime(2023, 1, 2, 17, 5, 4, 511, DateTimeKind.Local).AddTicks(169)
                        },
                        new
                        {
                            Id = 3,
                            Arrival = new DateTime(2023, 1, 3, 9, 5, 4, 511, DateTimeKind.Local).AddTicks(175),
                            Departure = new DateTime(2023, 1, 3, 7, 5, 4, 511, DateTimeKind.Local).AddTicks(172)
                        });
                });
