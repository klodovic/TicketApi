...
namespace TicketApi.Migrations
{
    ...
    [Migration("20230103161242_updateLocalUserTable")]
    partial class updateLocalUserTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketApi.Models.Passenger", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreditCardId = 1,
                            DateOfBirth = new DateTime(1983, 1, 3, 17, 12, 42, 59, DateTimeKind.Local).AddTicks(1344),
                            LoyaltyProgramId = 1,
                            ReportId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreditCardId = 2,
                            DateOfBirth = new DateTime(1967, 1, 3, 17, 12, 42, 59, DateTimeKind.Local).AddTicks(1350),
                            LoyaltyProgramId = 2,
                            ReportId = 2
                        });
                });
            ...
            modelBuilder.Entity("TicketApi.Models.Schedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Arrival = new DateTime(2023, 1, 3, 20, 12, 42, 59, DateTimeKind.Local).AddTicks(1134),
                            Departure = new DateTime(2023, 1, 3, 17, 12, 42, 59, DateTimeKind.Local).AddTicks(1100)
                        },
                        new
                        {
                            Id = 2,
                            Arrival = new DateTime(2023, 1, 3, 17, 12, 42, 59, DateTimeKind.Local).AddTicks(1140),
                            Departure = new DateTime(2023, 1, 2, 17, 12, 42, 59, DateTimeKind.Local).AddTicks(1137)
                        },
                        new
                        {
                            Id = 3,
                            Arrival = new DateTime(2023, 1, 3, 9, 12, 42, 59, DateTimeKind.Local).AddTicks(1143),
                            Departure = new DateTime(2023, 1, 3, 7, 12, 42, 59, DateTimeKind.Local).AddTicks(1140)
                        });
                });
